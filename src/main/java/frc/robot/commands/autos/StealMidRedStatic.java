...
public class StealMidRedStatic {
    ...
    public static Command getLeft(SwerveSubsystem swerveSubsystem, TurretSubsystem m_turret, Intake m_intake,
        ...
        StealMidRedStatic.s_angle = m_angle;
        StealMidRedStatic.s_shooter = m_shooter;
        StealMidRedStatic.s_turret = m_turret;
        StealMidRedStatic.s_intake = m_intake;
        ...
        var built_path_1 = StealMidRedStatic.buildAutoFollower(swerveSubsystem, path_1,
                StealMidRedStatic::pathObserver1, .75);
        var built_path_2 = StealMidRedStatic.buildAutoFollower(swerveSubsystem, path_2,
                StealMidRedStatic::pathObserver2, .85);
        var built_path_3 = StealMidRedStatic.buildAutoFollower(swerveSubsystem, path_3,
                StealMidRedStatic::pathObserver3, .85);
