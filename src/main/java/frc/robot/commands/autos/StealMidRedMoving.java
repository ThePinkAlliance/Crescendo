...
public class StealMidRedMoving {
    ...
    public static Command getLeft(SwerveSubsystem swerveSubsystem, TurretSubsystem m_turret, Intake m_intake,
        ...
        StealMidRedMoving.s_angle = m_angle;
        StealMidRedMoving.s_shooter = m_shooter;
        StealMidRedMoving.s_turret = m_turret;
        StealMidRedMoving.s_intake = m_intake;

        var path_1 = Choreo.getTrajectory("steal-mid2.1");
        var path_2 = Choreo.getTrajectory("steal-mid2.2");
        var path_3 = Choreo.getTrajectory("steal-mid2.3");
        Pose2d path_pose_1 = path_1.getInitialPose();

        var built_path_1 = StealMidRedMoving.buildAutoFollower(swerveSubsystem, path_1,
                StealMidRedMoving::pathObserver1, .75);
        var built_path_2 = StealMidRedMoving.buildAutoFollower(swerveSubsystem, path_2,
                StealMidRedMoving::pathObserver2, .85);
        var built_path_3 = StealMidRedMoving.buildAutoFollower(swerveSubsystem, path_3,
                StealMidRedMoving::pathObserver3, .85);
