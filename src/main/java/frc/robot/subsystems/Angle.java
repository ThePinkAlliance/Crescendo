...
public class Angle extends SubsystemBase {
  ...
  private LinearFilter angle_filter;
  ...
  public Angle() {
    ...
    this.angle_filter = LinearFilter.movingAverage(5);

    var cancoderConfig = new CANcoderConfiguration();
    cancoderConfig.MagnetSensor.AbsoluteSensorRange = AbsoluteSensorRangeValue.Unsigned_0To1;
    // 11:38 AM, 1.55 was reporting -359 position due to system drift. readjust as
    // needed.
    cancoderConfig.MagnetSensor.MagnetOffset = -0.138 - 0.020;
  ...
  public void periodic() {
    ...
    Logger.recordOutput("Shooter/CANcoder Angle Real",
        (angle_filter.calculate(getCancoderAngle())));
