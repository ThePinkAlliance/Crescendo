...
public class ClimberR2 extends SubsystemBase {
  ...
  public Command setTarget(double leftT,double rightT){
      ...
      double leftTarget=SmartDashboard.getBoolean("Climber use Shuffleboard", false)?SmartDashboard.getNumber("Left Target", 0):leftT;
      double rightTarget=SmartDashboard.getBoolean("Climber use Shuffleboard", false)?SmartDashboard.getNumber("Right Target", 0):rightT;
